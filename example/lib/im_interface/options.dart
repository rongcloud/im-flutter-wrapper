...
const subList = {
  "其他配置": [
    ...
    other.setNotificationQuietHoursWithSetting,
  ...
  "会话相关": [
    ...
    conversation.getRemoteConversationList,
    conversation.removeConversation,
    conversation.removeConversationWithDeleteRemote,
    ...
    conversation.getConversationsByIdentifiers,
    conversation.removeConversationsByIdentifiers,
  ],
  "消息相关": [
    ...
    message.recallMessageWithOption,
    message.sendPrivateReadReceiptMessage,
    message.sendGroupReadReceiptRequest,
    message.sendGroupReadReceiptResponse,
    message.sendReadReceiptResponseV5,
    message.getMessageReadReceiptInfoV5,
    message.getMessageReadReceiptInfoV5ByIdentifiers,
    message.getMessagesReadReceiptUsersByPageV5,
    message.getMessagesReadReceiptByUsersV5,
...
const cbList = [
  ...
  "removeConversation",
  "removeConversationWithDeleteRemote",
  "removeConversations",
  "getConversationsByIdentifiers",
  "removeConversationsByIdentifiers",
  "getUnreadCount",
  "getTotalUnreadCount",
