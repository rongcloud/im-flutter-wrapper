...
abstract class RCIMWrapperPlatform extends PlatformInterface {
  ...
  Future<RCIMIWCombineV2Message?> createCombineV2Message(
    ...
    throw UnimplementedError('createCombineV2Message() has not been implemented.');
  }
  ...
  Future<int> getRemoteConversationList({IRCIMIWOperationCallback? callback}) async {
    throw UnimplementedError('getRemoteConversationList() has not been implemented.');
  }
  ...
  Future<int> removeConversationWithDeleteRemote(
    ...
    throw UnimplementedError('removeConversationWithDeleteRemote() has not been implemented.');
  }
  ...
  Future<int> setNotificationQuietHoursWithSetting(
    ...
    throw UnimplementedError('setNotificationQuietHoursWithSetting() has not been implemented.');
  }
  ...
  Future<RCIMIWAppSettings?> getAppSettings() async {
    throw UnimplementedError('getAppSettings() has not been implemented.');
  }
  ...
  Future<int> requestStreamMessageContent(
    ...
    throw UnimplementedError('requestStreamMessageContent() has not been implemented.');
  }
  ...
  Future<int> requestSpeechToTextForMessage(String messageUId, {IRCIMIWOperationCallback? callback}) async {
    throw UnimplementedError('requestSpeechToTextForMessage() has not been implemented.');
  }
