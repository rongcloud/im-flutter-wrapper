...
enum RCIMIWPushNotificationLevel {
  ...
  /// 未设置。未设置时均为此初始状态。<br/><br/>*注意*：在此状态下，如果超级群与群频道均为未设置，则认为超级群与频道的默认免打扰级别为全部消息都通知。
  none,

  /// 仅针对@消息进行通知，包括@指定用户和@所有人
  mention,

  /// 仅针对@指定用户消息进行通知，且仅针对被@的指定的用户进行通知。<br/><br/>如：@张三，则张三可以收到推送；@所有人不会触发推送通知。</p>
  mentionUsers,

  /// 仅针对@群全员进行通知，即只接收@所有人的推送信息。
  mentionAll,
