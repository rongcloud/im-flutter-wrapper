...
class RCIMIWEngine {
  ...
  Future<int> sendReadReceiptResponseV5(
    ...
    return RCIMWrapperPlatform.instance.sendReadReceiptResponseV5(
      type,
      targetId,
      channelId,
      messageUIds,
  ...
  Future<int> getMessageReadReceiptInfoV5(
    ...
    return RCIMWrapperPlatform.instance.getMessageReadReceiptInfoV5(
      type,
      targetId,
      channelId,
      messageUIds,
  ...
  Future<int> getMessageReadReceiptInfoV5ByIdentifiers(
    ...
    return RCIMWrapperPlatform.instance.getMessageReadReceiptInfoV5ByIdentifiers(identifiers, callback: callback);
  }
  ...
  Future<int> getMessagesReadReceiptUsersByPageV5(
    ...
    return RCIMWrapperPlatform.instance.getMessagesReadReceiptUsersByPageV5(
      type,
      targetId,
      channelId,
      messageUId,
  ...
  Future<int> getMessagesReadReceiptByUsersV5(
    ...
    return RCIMWrapperPlatform.instance.getMessagesReadReceiptByUsersV5(
      type,
      targetId,
      channelId,
      messageUId,
  ...
  /// [EN]
  /// ---
  /// Read receipt V5 received callback
  /// - [responses] Read receipt response list
  /// ---
