...
# 5.32.4
* 修复了 Android 平台在 Web 对端发送消息格式错误的情况下闪退问题
...
# 5.32.1
* 更新了 Android IMLib SDK 依赖为 5.34.2。
* 增加了获取远端会话列表功能。
* 增加了删除远端会话功能。

# 5.32.0
* 更新了 Android IMLib SDK 依赖为 5.32.2。
* 更新了 iOS IMLib SDK 依赖为 5.32.0。
* 增加了图片消息宽高属性。
* 增加了合并转发V2类型消息。
* 增加了流式消息。
* 增加了好友信息托管功能。
